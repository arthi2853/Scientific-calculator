...
public class ScientificCalculator {
    ...
    private void initialize() {
        ...
        btnLn.setBackground(Color.yellow);
        ...
        btnXrx.setBackground(Color.yellow);
        ...
        btnCe.setBackground(Color.yellow);
        ...
        btnEx.setBackground(Color.yellow);
        ...
        btnCos_1.setBackground(Color.yellow);
        ...
        btnTan_1.setBackground(Color.yellow);
        ...
        btnP_1.setBackground(Color.yellow);
